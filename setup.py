"""
This is the setup module for the pushtt project.
...
setup(
    ...
    version=get_version("src/pushtt/_version.py"),
    ...
    project_urls={
        "Source": "https://github.com/khulnasoft-lab/pushtt",
        "Tracker": "https://github.com/khulnasoft-lab/pushtt/issues",
    },
    # Author details
    ...
    # Conveniently allows one to run the CLI tool as `pushtt`
    entry_points={"console_scripts": ["pushtt = pushtt.cli:main"]},
)
